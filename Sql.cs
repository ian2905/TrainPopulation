...
namespace TrainPopulation
{
    public class Sql
    {
        ...
        public void DropTables()
        {
            ...
            {
                connection.Open();
                string sqlRequest = @"  DROP TABLE IF EXISTS Trains.PassengerRoute;
        ...
        public void InsertCarTypes()
        {
            using (var connection = new SqlConnection(ConnectionString))
            {
                connection.Open();
                string sqlRequest = @"  INSERT Trains.CarType([Name])
                                        VALUES(N'Economy');

                                        INSERT Trains.CarType([Name])
                                        VALUES(N'Business');

                                        INSERT Trains.CarType([Name])
                                        VALUES(N'First Class');";
        ...
        public void RecreateTables()
        {
            ...
            {
                connection.Open();
                string sqlRequest = @"  IF OBJECT_ID(N'Trains.Train') IS NULL
                                        BEGIN
